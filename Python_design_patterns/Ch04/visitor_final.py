"""
The Visitor design pattern allows adding new features to an existing class hierarchy
without changing it. It is sometimes necessary to add new operations dynamically to
existing classes with minimal changes. For our scenario, we present a House class.
Visitors in this scenario include HVAC specialist and Electrician. HVAC specialist in
our scenario is Visitor type 1 and Electrician is Visitor type 2.
The visitor pattern represents new operations to be performed on the various elements
of an existing class hierarchy. Visitors can also provide operations on a composite object.
"""

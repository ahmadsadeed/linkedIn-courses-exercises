...
def detectFaces(img_path, display=False):
    ...
    cascade = cv2.CascadeClassifier('/Users/sadeed/opt/anaconda3/envs/my38env/share/opencv4/haarcascades'
...
def main():
    ...
    root = tk.Tk()
    root.withdraw()
    # img_path = filedialog.askopenfilename(initialdir='/Users/sadeed/',
    #                                       title='Choose an Image to Analyze')
    # filetypes = (('all files', '*.*'),
    #              ('JPEG', '*.jpg;*.jpeg'),
    #              ('GIF', '*.gif'),
    #              ('PNG', '*.png'))
    img_path = '/Users/sadeed/Desktop/20190913_190912.jpg'

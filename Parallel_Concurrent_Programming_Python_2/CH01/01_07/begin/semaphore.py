...
# a Mutex can be acquired/released by the one thread
# a Semaphore can be acquired/released by multiple threads
# Semaphore can be used to synchronize threads

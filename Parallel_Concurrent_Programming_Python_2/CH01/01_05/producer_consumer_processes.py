...
# python interpreter lock (PIL) only allows one thread to run at a time so
# creating more threads won't prevent the problem in this code. The solution is
# to use multi-processing and its queue implementation.

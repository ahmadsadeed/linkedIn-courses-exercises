...
# using a Barrier will result in same results in different runs
# it will prevent the race condition
...
def barron_shopper():
    ...
    # this line will ensure the olivia thread executes before the lines below
    fist_bump.wait()
    with pencil:
        bags_of_chips *= 2
